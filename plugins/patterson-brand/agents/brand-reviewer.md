---
name: brand-reviewer
description: Patterson brand-compliance reviewer. Use to audit existing UI, copy, or designs against the Patterson brand (colors, type, shape, voice, motion). Works from the files bundled in the patterson-brand plugin.
---
